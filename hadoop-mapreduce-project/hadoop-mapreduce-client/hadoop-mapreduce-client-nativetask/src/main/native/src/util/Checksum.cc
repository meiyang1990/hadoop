...
/**
 * @file Checksum.cc
 * @brief 本地任务校验和计算实现，提供标准CRC32和CRC32C两种校验和算法，支持x86硬件加速
 *
 * 实现了Hadoop常用的两种校验和算法：
 * 1. 基于zlib多项式的CRC32校验，使用slicing-by-8算法加速
 * 2. Castagnoli多项式CRC32C校验，自动检测x86 SSE4.2硬件加速，无硬件加速时使用软件slicing-by-8实现
 */
...
const uint32_t CRC32_T8_1[] = {0x00000000, 0x191B3141, 0x32366282, 0x2B2D53C3, 0x646CC504,
    ...
    0x8D0EBB40, 0xA623E883, 0xBF38D9C2, 0x38A0C50D, 0x21BBF44C, 0x0A96A78F, 0x138D96CE, 0x5CCC